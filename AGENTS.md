...
AI-generated product pages are drafts. They must separate confirmed facts from background explanation, preserve source accuracy, mark uncertain data, avoid invented parameters, and pass product publish QA before public use.

## WordPress Rule

Default WordPress action is draft creation or staging implementation. Publishing, production changes, DNS changes, plugin installation/removal, bulk import, and URL changes require explicit approval.
...
2. What test need it solves
3. Which standard or test method direction it relates to
4. What sample or product is tested
5. What configuration details matter
6. Whether it is an existing product, custom development direction, or R&D reference
7. What information to submit for quotation or solution evaluation
