...
Produce Chinese product name, English product name, model number, product family, product category, product status, test object, sample type, test items, technical parameters, related standards, related applications, related products, images/PDFs, source notes per field, human verification status, and public-use status.
