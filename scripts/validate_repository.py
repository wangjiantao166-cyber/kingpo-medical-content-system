...
def main() -> None:
    ...
    required_docs = [
        ...
        "docs/wordpress-operations-and-deployment.md",
        "docs/wordpress-rest-wpcli-operation-contract.md",
        "docs/wordpress-content-publishing-runbook.md",
        "docs/staging-production-topology.md",
        "docs/plugin-theme-release-process.md",
        "docs/secrets-and-access-policy.md",
        "docs/wordpress-security-baseline.md",
